            ...
            <div class="card px-5 row d-flex justify-content-center rounded-4"
                ...
                <div class="d-flex flex-start w-100 sticky-bottom z-2 rounded-4"
                    ...
                    <img class="rounded-circle shadow-1-strong me-3"
                        ...
                        height="65" />
                    <form method="post" action="{{ route('posts.comments.store', $comments->first()->post->id) }}"
                        class="w-100">
                        @csrf
                        <label class="h4" for="reply">
                            {{ $comments->first() ? 'Reply to ' . $comments->first()->user->name : 'Add Comment!' }}
                        </label>
